...
namespace ForumTopics
{
    public class Program
    {
        ...
        public static void Main()
        {
            ...
            {
                var currentData = currentLine.Split(new[] { " -> ", ", " }, StringSplitOptions.RemoveEmptyEntries);
            ...
            var filteredTags = Console.ReadLine().Split(new[] { ", " }, StringSplitOptions.RemoveEmptyEntries);
