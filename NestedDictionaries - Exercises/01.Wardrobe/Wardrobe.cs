...
namespace Wardrobe
{
    public class Program
    {
        public static void Main()
        {
            ...
            {
                var currentDataClothesByColor = Console.ReadLine().Split(new[] { " -> ", "," }, StringSplitOptions.RemoveEmptyEntries);
            ...
            var colorAndItemPairToFind = Console.ReadLine().Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries);
